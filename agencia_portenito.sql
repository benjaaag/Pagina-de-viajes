...
--
-- Servidor: localhost
-- Tiempo de generación: 10-12-2025 a las 12:46:06
...
CREATE TABLE `paquete` (
  ...
  `servicio_incluido` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `paquete` (`id_paquete`, `nombre`, `descripcion_corta`, `descripcion_larga`, `precio`, `limite_personas`, `fecha_inicio`, `fecha_fin`, `estado`, `Imagen`, `personas_reservadas`, `servicio_incluido`) VALUES
...
CREATE TABLE `servicio` (
  ...
  `servicio_incluido` text DEFAULT NULL,
...
INSERT INTO `servicio` (`id_servicio`, `nombre_servicio`, `servicio_incluido`, `proveedor`, `tipo`, `precio`) VALUES
...
(6, 'matip', '$2y$10$aMviq7YikMK4.LqV1XNokebgA67Xt97k4bMqVV0P24n413CLJDBx6', NULL, NULL),
(7, 'aas', '$2y$10$Jjsp6.pFh0Nkw83bVqaIlu1rKh0LfbWKpsTPslWZKCgLbqn.1vf3S', NULL, NULL),
(8, 'rube', '$2y$10$WyqeDRBmj9iarEZ3roVdHOBHO2iXsJxj7jtKFO1ApSYLy.m/KPX9C', NULL, NULL),
(9, 'mati11', '$2y$10$naSRXy2I9OeVHpiblOXn3OE/wkJmsOxrUGq8JRJmYQ92mp7C3w3we', NULL, NULL),
(10, 'MTY', '$2y$10$B1tZwaPJP64aDKWJvB8lR.rQ.9Z8DvTSK5SLWy/m2Cm2Y2mhKj.x.', NULL, NULL);
